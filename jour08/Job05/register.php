            ...
            <form id="formRegister" action="" method="post" class="space-y-4">
                <div>
                    ...
                    <div class="flex gap-4">
                        <label class="flex items-center gap-2"><input type="radio" name="civilite" value="monsieur" required>Monsieur</label>
                        <label class="flex items-center gap-2"><input type="radio" name="civilite" value="madame" required>Madame</label>
                        <label class="flex items-center gap-2"><input type="radio" name="civilite" value="autre" required>Autre</label>
                    </div>
                </div>
                <div class="flex gap-3">
                    ...
                    <div class="flex-1">
                        <label class="block text-sm mb-1" for="">Nom :</label>
                        <input type="text" name="nom" class="w-full p-2 rounded bg-white/10 border border-white/20" required>
                ...
                <div>
                    ...
                    <input type="email" name="email" id ="email" class="w-full p-2 rounded bg-white/10 border border-white/20" required>
