...
<body class ="bg-gradient-to-br from-purple-600 via-indigo-600 to-blue-800 text-white min-h-screen">
    ...
    <main class ="flex justify-center items-start py-12 px-4">
        <section class ="bg-white/10 backdrop-blur-md rounded-xl p-8 w-full max-w-md shadow-lg">
            ...
            <form id ="formLogin" action="" method="post" class ="space-y-4">
                ...
                <button type ="submit" class ="w-full bg-yellow-300 text-black py-2 rounded">Connexion</button>
            </form>
        </section>
    </main>
