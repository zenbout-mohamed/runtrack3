...
<body class="bg-gray-100 flex flex-col items-center justify-center min-h-screen">
    ...
    <section class="bg-white shadow-md rounded-lg p-8 text-center w-full max-w-md">
        <?php if (isset($_SESSION['prenom'])) : ?>
            <h1 class="text-2xl mb-4 font-bold text-teal-600">
        ...
        <?php else : ?>
            ...
            <div class="flex justify-center gap-4">
                ...
                <a href="connexion.php" class="bg-indigo-500 text-white px-4 py-2 rounded hover:bg-indigo-600 transition">Connexion</a>
            </div>
        <?php endif; ?>
    </section>
